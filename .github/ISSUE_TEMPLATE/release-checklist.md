...
- [ ] Approve Helm chart index update PR in knative/operator ([see example PR](https://github.com/knative/operator/pull/2335) generated by [action](https://github.com/knative/operator/actions/workflows/publish-helm.yaml))
