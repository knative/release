...
| [knative.dev/kn-plugin-func](https://github.com/knative-sandbox/kn-plugin-func)   | [![Releases](https://img.shields.io/github/release-pre/knative-sandbox/kn-plugin-func.svg?sort=semver)](https://github.com/knative-sandbox/kn-plugin-func/releases)  | [![Releasability](https://github.com/knative-sandbox/kn-plugin-func/workflows/Releasability/badge.svg)](https://github.com/knative-sandbox/kn-plugin-func/actions/workflows/knative-releasability.yaml) | [![Nightly](https://prow.knative.dev/badge.svg?jobs=nightly_kn-plugin-func_main_periodic)](https://prow.knative.dev?job=nightly_kn-plugin-func_main_periodic) |
